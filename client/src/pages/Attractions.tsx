            ...
            {attractions.map((place, i) => (
              ...
              >
                <div className="aspect-[4/3] overflow-hidden mb-6 border border-white/10 relative">
                  ...
                  <img 
                    src={place.image} 
                    alt={isEn ? place.nameEn : place.name} 
                ...
                <div className="space-y-3">
                  <h3 className="font-serif text-2xl text-white group-hover:text-gold-500 transition-colors">{isEn ? place.nameEn : place.name}</h3>
                  <div className="w-8 h-[1px] bg-gold-500"></div>
                  <p className="text-white/50 text-sm leading-relaxed font-light">
                    {isEn ? place.descriptionEn : place.description}
                  </p>
                </div>
              </motion.div>
            ))}
